...
describe('GET /api/campgrounds/:id/comments', function() {
  ...
  it('respond with json containing a list of all comments for a campground', function(done) {
    request(app)
      .get('/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments')
...
describe('POST /api/campgrounds/:id/comments', function() {
  ...
  it('respond with 401 unauthorized', function(done) {
    request(app)
      .post('/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments')
      .send(data)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      .expect(401)
...
describe('GET /api/campgrounds/:id/comments/:comment_id', function() {
  it('respond with json comment not found', function(done) {
    request(app)
      .get(`/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments/weirdcommentid`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
  ...
  it(`respond with json containing a single campground's comment`, function(done) {
    request(app)
      .get(`/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments/${comment._id}`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      .expect(200, done);
  });
...
describe('PUT /api/campgrounds/:id/comments/:comment_id', function() {
  ...
  it('respond with 404 not found', function(done) {
    request(app)
      .put(
        `/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments/thisIdDoesNotExist`
      )
      .set('x-auth-token', token)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
  ...
  it('respond with 401 unauthorized', function(done) {
    request(app)
      .put(`/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments/${comment._id}`)
      .send(data)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      .expect(401)
...
describe('DELETE /api/campgrounds/:id/comments/:comment_id', function() {
  ...
  it('respond with 404 not found', function(done) {
    request(app)
      .delete(
        `/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments/notexistingid`
      )
      .set('x-auth-token', token)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
  ...
  it('respond with 401 unauthorized', function(done) {
    request(app)
      .delete(
        `/api/campgrounds/5df0c3b3bb69ba19804fb4a6/comments/${comment._id}`
      )
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      .expect(401)
